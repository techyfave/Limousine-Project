...
function Corporate2() {
  return (
    <div className="px-4 corporate-2-container pb-4">
      <h2 className="fs-3 fw-bold text-center">
        Seamless Travel, Maximum Productivity
      </h2>
      <p className="text-center pt-3 pb-5">
        Say goodbye to the hassle of commuting and hello to the convenience of
        corporate transportation <br /> services designed with your needs in
        mind. Whether you’re traveling to a court hearing, business <br />{" "}
        meeting, or conference, we provide more than just a ride—our service is
      ...
      <div className="corporate-2-items mb-4">
        <Row>
          <Col sm={12} md={6} lg={3}>
            <div>
              <h2 className="fs-4 fw-bold">Real-Time Updates</h2>
              <p>
          ...
          <Col sm={12} md={6} lg={3}>
            <div>
              <h2 className="fs-4 fw-bold">Stay Connected</h2>
              <p>
          ...
          <Col sm={12} md={6} lg={3}>
            <div>
              <h2 className="fs-4 fw-bold">Work On-The-Go</h2>
              <p>
          ...
          <Col sm={12} md={6} lg={3}>
            <div>
              <h2 className="fs-4 fw-bold">Reliability You Can Trust</h2>
              <p>
